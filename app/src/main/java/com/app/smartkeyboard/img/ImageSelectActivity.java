...
import com.app.smartkeyboard.action.GridSpaceDecoration;
import com.app.smartkeyboard.action.SingleClick;
import com.app.smartkeyboard.action.StatusAction;
import com.app.smartkeyboard.action.ThreadPoolManager;
import com.app.smartkeyboard.adapter.ImageSelectAdapter;
import com.app.smartkeyboard.dialog.AlbumDialog;
import com.app.smartkeyboard.widget.StatusLayout;
...
public final class ImageSelectActivity extends AppActivity
    ...
    public void run() {
       ...
       // Log.e("TAG","----cursor----"+(cursor==null)+" "+(XXPermissions.isGranted(this, Permission.READ_EXTERNAL_STORAGE))) ;
