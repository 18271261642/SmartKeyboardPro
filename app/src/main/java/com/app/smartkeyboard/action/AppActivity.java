package com.app.smartkeyboard.action;
...
import com.app.smartkeyboard.dialog.WaitDialog;
import com.app.smartkeyboard.second.SecondScanActivity;
...
//    }
    ...
    public void showConnDialog(){
        DeleteDeviceDialog dialog = new DeleteDeviceDialog(this, com.bonlala.base.R.style.BaseDialogTheme);
        dialog.show();
        dialog.setTitleTxt(getResources().getString(R.string.string_to_conn_prompt));
        dialog.setOnCommClickListener(new OnCommItemClickListener() {
            @Override
            public void onItemClick(int position) {
                dialog.dismiss();
                if(position == 0x01){   //确定
                    startActivity(SecondScanActivity.class);
                }
            }
        });
        ...
        int widthW = metrics2.widthPixels;
