...
//        };
     ...
     * @return B的指令数组
     */
    public static byte[] dealWidthBData(int imgCount,int gifSpeed,boolean isSecond){

        //计算结果的速度
        int resultSpeed =11 -gifSpeed;


        byte[] bt1 = new byte[]{0x15, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x01, (byte) (isSecond ? 0x86 :  0x40), (byte) (isSecond ? 0x01 :  0x00), (byte) (isSecond ? 0x86 :  0xAC), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        byte[] bt2 = new byte[]{0x14, 0x03, 0x00, 0x01, (byte) resultSpeed, 0x00, 0x00, (byte) imgCount, 0x00, 0x00, 0x01, (byte) (isSecond ? 0x86 :  0x40), (byte) (isSecond ? 0x01 :  0x00), (byte) (isSecond ? 0x86 :  0xAC), 0x00, 0x00, 0x00, 0x00 ,0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ,0x00, 0x00, 0x00, 0x00};
        byte[] bt3 = new byte[]{0x14, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, (byte) (isSecond ? 0x86 :  0x40), (byte) (isSecond ? 0x01 :  0x00), (byte) (isSecond ? 0x86 :  0xAC), 0x00, 0x00, 0x00, 0x00 ,0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ,0x00, 0x00, 0x00, 0x00};
